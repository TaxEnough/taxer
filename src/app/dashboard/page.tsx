        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 mb-6 shadow-sm">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-indigo-800">Premium Content</h3>
                <div className="mt-1 text-sm text-indigo-600">
                  <p>This dashboard is available only to users with an active subscription. Free users can upgrade their account on the pricing page.</p>
                </div>
              </div>
            </div>
          </div>
